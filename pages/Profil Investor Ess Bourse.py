...
st.set_page_config(layout="wide", page_title = "Profil Investor Ess Bourse", page_icon="https://cdn.pixabay.com/photo/2016/11/21/17/59/blackboard-1846865_640.jpg", initial_sidebar_state="expanded") 
...
st.markdown(
   ...
   .stApp {
        ...
        background-image: url('https://cdn.pixabay.com/photo/2016/11/21/17/59/blackboard-1846865_640.jpg');
